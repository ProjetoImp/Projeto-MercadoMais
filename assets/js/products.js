// Base de dados teste
let allProducts = [
    { id: 1, codigo: 'PRD001', nome: 'Arroz', categoria: 'Alimentos', preco: 25.90, estoque: 50 },
    { id: 2, codigo: 'PRD002', nome: 'Leite', categoria: 'Bebidas', preco: 5.50, estoque: 8 },
    { id: 3, codigo: 'PRD003', nome: 'Sabonete', categoria: 'Perfumaria', preco: 2.50, estoque: 15 },
    { id: 4, codigo: 'PRD004', nome: 'Sabão em pó', categoria: 'Limpeza', preco: 25.90, estoque: 20 }
];
...
function renderTable(products = allProducts) {
    ...
    if (products.length === 0) {
        ...
        products.forEach(p => {
            const estoqueClasse = p.estoque < 1 ? 'text-red-600 font-bold' : 'text-slate-800';
            ...
            tbody.innerHTML += `
                <tr class="hover:bg-slate-50 transition-colors border-b border-slate-100">
                    ...
                    <td class="px-6 py-4 ${estoqueClasse}">${p.estoque} un</td>
                    <!-- Função de editar e excluir comentada -->
...
function handleFormSubmit(e) {
    ...
    if (idExistente) {
        ...
        allProducts[index] = { id: parseInt(idExistente), ...dados };
